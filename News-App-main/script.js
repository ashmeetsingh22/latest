// GNews API Configuration (replace with your actual key)
const API_KEY = "c7acd51b133e260c42c0e5f629a9885c";
...
async function fetchNews(query) {
    try {
        ...
        const response = await fetch(`${BASE_URL}?q=${encodeURIComponent(query)}&token=${API_KEY}`);
        ...
        // Show error message in your original style
